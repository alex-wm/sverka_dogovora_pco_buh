...
buh_lost = open("buh"+pnum+"_lost.csv", "w")
pco_lost = open("pco"+pnum+"_lost.csv", "w")
...
pco_lost.write("Договора не обнаруженные в списке БУХГАЛТЕРИЯ-"+pnum+"\n")
...
buh_lost.write("Договора не обнаруженные в списке ПЦО-"+pnum+"\n")
